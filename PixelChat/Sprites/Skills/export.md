...
Export from an explicit document revision. Preserve the editable native document, PNG frames or atlas, frame durations, clip direction/loop policy, logical dimensions, offsets, pivots and slices.
