...
public static class AssistantPromptBuilder
{
    public static string Build() =>
        ...
        6. Inspect candidate images and `read_animation_job` as needed. Use `mark_animation_frames` to accept, reject, warn, or request repair for exact 1-based frame numbers. Do not accept raw-QA clipped or slot-crossing frames unless deliberately setting `forceAccept` and reporting that tradeoff.
